...
public class Square3 {
    ...
    float[] color = {0.0f, 0.5f, 2.3f, 1.0f};

    // 그리는 순서
    short[] drawOrder = {0, 4, 3, 1, 2, 4};
    ...
    public Square3() {
        ...
        // 점위치 계산
        // vertextShaderCode -> vertexShader
    ...
    // 도형그리기 --> MyGLRenderer.onDrawFrame()에서 호출하여 그리기기
    void draw(float[] mMVPMatrix) {
        ...
        GLES20.glVertexAttribPointer(
                ...
                false,  //정규화 할거면 true, 직접변환 시 false
                3 * 4,      // 점 속성의 stride(간격)
                vertexBuffer    // 점 정보
